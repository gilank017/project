                            ...
                            <v-col cols="12">
                              <v-list>
                                ...
                                >
                                  ...
                                  <v-list-item-title
                                    >Product:
                                    {{ value.product_name }}</v-list-item-title
                                  >
                  ...
                  <template v-slot:default>
                    ...
                    <tbody>
                      <tr v-for="(value, index) in detailProduct" :key="index">
                        ...
                        <td>
                          <v-icon @click="removeDetailProduct">clear</v-icon>
                        </td>
                      </tr>
                    </tbody>
                  </template>
...
export default {
  ...
  methods: {
    ...
    removeProduct(indexProduct) {
      ...
      this.valueProduct.splice(this.activeProduct, 1);
    },
    ...
    saveData() {
      ...
      const body = {
        ...
        items: this.detailProduct,
      };
      Proxy.post(uri + "/api/orders", body, { headers })
        .then((res) => {
          console.log(res);
          this.$router.push("/Menu/Order");
